...
describe("plaidSyncTool", () => {
  it("should have correct metadata", () => {
    ...
    expect(plaidSyncTool.description).toBe("Sync transactions from Plaid-connected bank accounts");
  });
...
describe("conversationalStatusTool", () => {
  it("should have correct metadata", () => {
    ...
    expect(conversationalStatusTool.description).toBe("Show account status with natural language");
  });
...
describe("conversationalHelpTool", () => {
  it("should have correct metadata", () => {
    ...
    expect(conversationalHelpTool.description).toBe("Get help with billclaw commands and features");
  });
