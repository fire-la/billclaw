...
exports.billParseTool = billParseTool;
/**
 * Parse bill data from various formats
 */
function billParseTool(params) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (params.source) {
                case "plaid":
                    return [2 /*return*/, parsePlaidData(params.data)];
                case "gmail":
                    return [2 /*return*/, parseGmailEmail(params.data)];
                case "file":
                    return [2 /*return*/, parseFile(params.data)];
                case "email":
                    return [2 /*return*/, parseEmail(params.data)];
                default:
                    return [2 /*return*/, {
                            success: false,
                            format: "unknown",
                            transactions: [],
                            errors: ["Unknown source type: ".concat(params.source)],
                        }];
            }
            return [2 /*return*/];
        });
